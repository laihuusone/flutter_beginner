...
class Exercise4 extends StatelessWidget {
            ...
            if (data.hasError) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.of(context).pushNamed(Exercise4Details.routeName,
                          arguments: "null");
                    },
                    child: Stack(
                      children: [
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            items[index].weatherDescription,
                                            style: TextStyle(
                                                fontSize: 20,
                                                fontWeight: FontWeight.bold,
                                                color: Colors.white),
                                  ...
                                  Expanded(
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            items[index].weatherTemp.toString() + "º",
                                            style: TextStyle(
                                                fontSize: 80,
                                                fontWeight: FontWeight.bold,
                                                color: Colors.white),
  ...
  Future<List<WeatherModel>> readJsonData() async {
    final jsondata =
